...
for(i = 0; i < ds_list_size(target_list); i++)
{
	...
	if(local_adv.class.name != "Dingus")
	{
		//draw background of adventurer information button
		bg_xscale = 600;
		bg_yscale = 75;
		draw_rectangle_color(ui_x-10, ui_y, (ui_x+bg_xscale),(ui_y+bg_yscale), c_gray,c_gray,c_gray,c_gray, 0); ui_y+=5;
