...
draw_text_outlined(start_x, start_y, c_black, text_color, adv.class.name + " : (" + string(adv.level) + ")", txt_scale); start_y += spacing;
...
draw_text_outlined(start_x + 300, start_y, c_black, text_color, "Damage Reduction: " + string(0.5 * (adv.str / 150)) + "%", txt_scale); start_y += spacing;

draw_text_outlined(start_x, start_y, c_black, text_color, "Magic Points: " + string(adv.mp), txt_scale); start_y += spacing;
draw_text_outlined(start_x, start_y, c_black, text_color, "Strength: " + string(adv.str), txt_scale); start_y += spacing;
...
draw_text_outlined(button_x + 50, button_y + (button_yscale/3), c_black, text_color, "Apply", 1);
